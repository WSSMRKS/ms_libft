...
/*   Updated: 2024/04/02 05:58:13 by kwurster         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_str			str_new_repeat(const unsigned char *s, size_t len, size_t n);
t_str			str_new_repeat_sized(const unsigned char *s, size_t l, size_t new_len, size_t n);
...
void			str_replace(t_str *str, unsigned char pattern, unsigned char s);
void			str_replace_first(t_str *str, unsigned char pattern, unsigned char s);
void			str_replace_first_str(t_str *str, const unsigned char *pattern, const unsigned char *s);
void			str_replace_last(t_str *str, unsigned char pattern, unsigned char s);
void			str_replace_last_str(t_str *str, const unsigned char *pattern, const unsigned char *s);
void			str_replace_range(t_str *str, size_t start, size_t end, const unsigned char *s);
void			str_replace_str(t_str *str, const unsigned char *pattern, const unsigned char *s);
...
void			str_trim_end_not(t_str *str, unsigned char c);
void			str_trim_end_not_set(t_str *str, const unsigned char *set);
void			str_trim_end_set(t_str *str, const unsigned char *set);
void			str_trim_not(t_str *str, unsigned char c);
void			str_trim_not_set(t_str *str, const unsigned char *set);
void			str_trim_set(t_str *str, const unsigned char *set);
void			str_trim_start(t_str *str);
void			str_trim_start_not(t_str *str, unsigned char c);
void			str_trim_start_not_set(t_str *str, const unsigned char *set);
void			str_trim_start_set(t_str *str, const unsigned char *set);
