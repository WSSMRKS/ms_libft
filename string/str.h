...
/*   Updated: 2024/03/27 22:09:00 by kwurster         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	str_replace_first_str(t_str *str, const char *pattern, const char *s);
void	str_replace_last(t_str *str, char pattern, char s);
void	str_replace_last_str(t_str *str, const char *pattern, const char *s);
void	str_replace_range(t_str *str, size_t start, size_t end, const char *s);
void	str_replace_str(t_str *str, const char *pattern, const char *s);
